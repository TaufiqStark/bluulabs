 ...
 *  Name, metadata, nav links, social links, contact
 * ╚══════════════════════════════════════════════════╝
 */
...
export const site = {
    name: "taufiq.",
    fullName: "Taufiq",
    title: "Taufiq — Developer & Designer",
    role: "Developer & Designer",
    description:
        "Full-stack developer crafting elegant digital experiences through clean code and thoughtful design.",
    keywords: ["developer", "designer", "portfolio", "full-stack", "web"],
    email: "hello@taufiq.dev",
...
export const themeConfig = {
    ...
    /** Viewport percentage (0–1) for triggering theme switch on scroll */
    viewportTrigger: 0.2,
} as const;
