...
export default function SettingsAdminPage() {
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight admin-text">System settings</h1>
        <p className="mt-1 text-sm admin-muted">Manage global configuration and environment variables.</p>
      </div>
