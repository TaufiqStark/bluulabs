  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-white">Works</h1>
          <p className="mt-1 text-sm text-white/60">Manage projects that appear in your portfolio.</p>
        </div>
        <Link
              ...
              {data.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 space-x-4">
                    <Link href={`/admin/work/${item.id}/edit`} className="text-blue-600 hover:text-blue-900">
                      Edit
                    </Link>
