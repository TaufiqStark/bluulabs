...
export default function CreateWritingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Let the backend API route inject the Date object
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-white">Write a new post</h1>
          <p className="mt-1 text-sm text-white/60">Create a new article for your blog.</p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 bg-white p-6 shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
        <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2 mt-4 pt-4 border-t border-gray-200">
             ...
             <Editor data={editorData} onChange={setEditorData} holder="writing-editor" />
          </div>
